...
<script type="text/javascript">
	...
	function openUtilizationList(mBizId,formId){
...
<div class='' id='offCanvasWrapper'>
 ...
 %> <span><img src="<%=request.getContextPath()%>/resource/mobile/cover_10.png"/></span><a
													...
													href=javascript:openUtilizationList('<%=list.get(i * 2).getUuid()%>','<%=list.get(i * 2).getFormId()%>')>
 ...
 %> <span><img src="<%=request.getContextPath()%>/resource/mobile/cover_10.png"/></span><a
													class="title-already-visited"
													style="text-decoration: none; color: #000000"
													href=javascript:openUtilizationList('<%=list.get(i * 2 + 1).getUuid()%>','<%=list.get(i * 2 + 1).getFormId()%>')>
