...
<link href='<%=request.getContextPath() %>/resource/css/filecss.css' rel="stylesheet"></link>
<link href='<%=request.getContextPath() %>/office/html5/assets/bootstrap-table/src/bootstrap-table.css'	rel="stylesheet"></link>
